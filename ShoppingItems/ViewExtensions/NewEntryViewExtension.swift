...
//    }
    ...
    public func saveTreatItem() {
        DispatchQueue.main.async {
            ...
            viewModel.addItem(itemToBeAdded: randomTreat.key,
                              quantitySelected: randomTreat.value,
                              notesOnItem: "\(stringStore.treatEmoji)",
    ...
    public func saveNewEntry() {
        //TODO: Need logic like the following to ensure that there is at least some quantity entered for the user by default
//        if quantitySelected.isEmpty && quantitySelected != "\(stringStore.treatEmoji)" {
//            itemToBeSaved.quantitySelected = "1"
//        }
        ...
        DispatchQueue.main.async {
            ...
            if trimmedItem.isEmpty{
                ...
                viewModel.addItem(itemToBeAdded: trimmedItem,
                                  quantitySelected: trimmedNote,
                                  notesOnItem: trimmedQuantity,
