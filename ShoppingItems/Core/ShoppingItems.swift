...
extension ShoppingItems {
    ...
    static func getAllShoppingItems() -> NSFetchRequest<ShoppingItems> {
        let request: NSFetchRequest <ShoppingItems> = ShoppingItems.fetchRequest() as! NSFetchRequest <ShoppingItems>
